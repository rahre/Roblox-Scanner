...
int main() {
    ...
    HINTERNET hConnect = WinHttpConnect(hSession, url.c_str(), 8080, 0);
    HINTERNET hRequest = WinHttpOpenRequest(hConnect, L"POST", path.c_str(), NULL, WINHTTP_NO_REFERER, WINHTTP_DEFAULT_ACCEPT_TYPES, 0);
    
    std::string ADMIN_KEY = "NatsuXAK2026\r";
    std::string ADMIN_NAME = "ak\r";
